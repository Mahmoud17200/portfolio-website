...
import "/src/pages-css/contactPage.css";
...
export default function ContactPage() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_0irkv2k", // Service ID
        "template_i2topc5", // Template ID
        e.target,
        "9EuGdwbrbS7nIm8Tr", // Public Key
      )
      .then(() => {
        setSuccess(true);
        e.target.reset();
    ...
    <div className="contact-page">
      ...
      <div className="contact-wrapper">
        ...
        <form onSubmit={sendEmail} className="contact-form">
          ...
          {success && (
            <p className={`success-msg ${success ? "active" : ""}`}>
        ...
        <div className="contact-info">
          <h3>Get in touch</h3>
          <p>Email: mahmoudlodzz12@gmail.com</p>
          <p>Phone: +201142948021</p>
          <p>Location: Cairo, Egypt</p>
          <div className="social-icons  d-flex align-items-center">
            {socialIcon.map((icon, i) => {
              return (
                <>
                  <Link className="social-link" key={i} to={links[i].link} target="_blank" rel="noopener noreferrer">
